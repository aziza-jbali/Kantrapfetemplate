...
function Cardsvehiculs() {
  const cars = [
    { title: "Range Rover S64 Coupe", img:car1, price: "$250/day", doors: 4, seats: 5, transmission: "Automatic", minAge: 18, rating: 5 },
    { title: "Tesla Model X", img: car2, price: "$300/day", doors: 4, seats: 5, transmission: "Automatic", minAge: 21, rating: 5 },
    { title: "BMW i8", img: car3, price: "$400/day", doors: 2, seats: 4, transmission: "Automatic", minAge: 21, rating: 4 },
    { title: "Audi Q7", img: car4, price: "$350/day", doors: 4, seats: 7, transmission: "Automatic", minAge: 21, rating: 5 },
    { title: "Mercedes GLE", img: car5, price: "$380/day", doors: 4, seats: 5, transmission: "Automatic", minAge: 21, rating: 5 },
    { title: "Porsche Taycan", img: car6, price: "$450/day", doors: 4, seats: 4, transmission: "Automatic", minAge: 25, rating: 5 },
    { title: "Lexus RX", img: "https://via.placeholder.com/400x250?text=Car+7", price: "$320/day", doors: 4, seats: 5, transmission: "Automatic", minAge: 21, rating: 4 },
    { title: "Jaguar F-Type", img: "https://via.placeholder.com/400x250?text=Car+8", price: "$420/day", doors: 2, seats: 2, transmission: "Automatic", minAge: 25, rating: 5 },
    { title: "Ford Mustang", img: "https://via.placeholder.com/400x250?text=Car+9", price: "$300/day", doors: 2, seats: 4, transmission: "Manual", minAge: 21, rating: 4 },
    { title: "Chevrolet Camaro", img: "https://via.placeholder.com/400x250?text=Car+10", price: "$350/day", doors: 2, seats: 4, transmission: "Manual", minAge: 21, rating: 4 },
    { title: "Nissan GT-R", img: "https://via.placeholder.com/400x250?text=Car+11", price: "$500/day", doors: 2, seats: 2, transmission: "Automatic", minAge: 25, rating: 5 },
    { title: "Honda Civic", img: "https://via.placeholder.com/400x250?text=Car+12", price: "$200/day", doors: 4, seats: 5, transmission: "Automatic", minAge: 18, rating: 4 },
    { title: "Toyota Corolla", img: "https://via.placeholder.com/400x250?text=Car+13", price: "$220/day", doors: 4, seats: 5, transmission: "Automatic", minAge: 18, rating: 4 },
    { title: "Kia Sportage", img: "https://via.placeholder.com/400x250?text=Car+14", price: "$230/day", doors: 4, seats: 5, transmission: "Automatic", minAge: 18, rating: 4 },
    { title: "Hyundai Tucson", img: "https://via.placeholder.com/400x250?text=Car+15", price: "$240/day", doors: 4, seats: 5, transmission: "Automatic", minAge: 18, rating: 4 },
    { title: "Mazda CX-5", img: "https://via.placeholder.com/400x250?text=Car+16", price: "$250/day", doors: 4, seats: 5, transmission: "Automatic", minAge: 18, rating: 4 },
    { title: "Subaru Outback", img: "https://via.placeholder.com/400x250?text=Car+17", price: "$260/day", doors: 4, seats: 5, transmission: "Automatic", minAge: 18, rating: 4 },
    { title: "Volkswagen Tiguan", img: "https://via.placeholder.com/400x250?text=Car+18", price: "$270/day", doors: 4, seats: 5, transmission: "Automatic", minAge: 18, rating: 4 },
  ];
        ...
        <div className="row g-4">
          {currentCards.map((car, index) => (
            <div style={{borderRadius:"70px"}} className="col-md-6 col-lg-4" key={index}>
              ...
              >
                <img  style={{height:"300px"}}  src={car.img} className="card-img-top" alt={car.title} />
